        ...
        <div className="flex-1 space-y-3">
          ...
          <div className="flex items-center gap-3">
            ...
            <button
              ...
              className="ml-auto p-1.5 rounded hover:bg-red-50 dark:hover:bg-red-950/30 text-[hsl(var(--muted-foreground))] hover:text-red-600 opacity-0 group-hover:opacity-100 transition-all"
              title="Delete block"
            >
